...
const TrendingPage: React.FC = () => {
  ...
  const fetchTrendingCoins = async () => {
    try {
      ...
      console.error('Trending verileri çekilemedi:', error);
      setError('Trending verileri çekilemedi. Lütfen tekrar deneyin.');
      setCoins([]);
    } finally {
      setLoading(false);
    }
        ...
        <div className="w-full px-6">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Dijital Marketim&apos;de Hangi Kripto Paralar Trend Oluyor?
            </h1>
            <p className="text-gray-600 text-lg max-w-3xl">
              Trend olan kripto paralar, son 24 saat içinde Dijital Marketim&apos;de en çok aranan ve görüntülenen kripto paralardır. 
              Bu liste, kullanıcı ilgisi ve arama hacmine göre gerçek zamanlı olarak güncellenir.
            </p>
          </div>
                        ...
                        <td className="py-4 px-6 text-center">
                          <div className="flex items-center justify-center gap-1">
                            <span className={`text-sm font-semibold ${
                              coin.trending_score > 0 ? 'text-green-600' : 'text-red-600'
                            }`}>
                              {coin.trending_score > 0 ? '↑' : '↓'}
                            </span>
