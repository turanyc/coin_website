...
const GasPricePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>Gas Fiyatı Detayları | Dijital Marketim</title>
      </Head>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Gas Fiyatı Detayları</h1>
