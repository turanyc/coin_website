...
const NavbarV2: React.FC<NavbarV2Props> = ({ onNavbarToggle, fearGreedIndex = 50, fearGreedClassification = 'Neutral' }) => {
    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50 h-16">
        <div className="flex items-center justify-between h-full px-6">
          {/* Sol taraf - Logo */}
          <Link href="/index-v2" className="h-10 flex items-center">
            <Image 
              src={logoImage}
